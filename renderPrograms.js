...
initializeTable(
  parecerCFData,
  "parecer-conselho-fiscal-table-body",
  "parecer-conselho-fiscal-section",
  "parecer-conselho-fiscal-container"
);

//Renderização Ata de aprovação PCA
initializeTable(
  aprovacaoPCAData,
  "ata-aprov-pca-table-body",
  "ata-aprov-pca-section",
  "ata-aprov-pca-container"
);
...
initializeTable(
  termoConselhoEscolarData,
  "termo-conselho-escolar-table-body",
  "termo-conselho-escolar-section",
  "termo-conselho-escolar-container"
);
initializeTable(
  ataEscolhaConselhoEscolarData,
  "ata-conselho-escolar-table-body",
  "ata-conselho-escolar-section",
  "ata-conselho-escolar-container"
);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (cleanButton) {
    cleanButton.addEventListener("click", resetAllForms);
  }
});
