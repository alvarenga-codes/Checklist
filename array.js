...
const acoesConfig = [
    ...
    },
    {
        ...
        tipo: 'multipla',
        opcoes: [
            { value: 'sala-de-recursos-multifuncionais', label: 'Programa Sala de Recursos Multifuncionais' },
            { value: 'escola-acessivel', label: 'Programa Escola Acessível' },
            { value: 'agua-e-esgotamento-sanitario', label: 'Programa Água e Esgotamento Sanitário nas Escolas Rurais' },
    ...
    },
    {
        ...
        opcoes: [
            ...
            { value: 'educacao-conectada', label: 'Programa de Inovação Educação Conectada' },
            ...
            { value: 'itinerarios-formativos', label: 'Programa Itinerários Formativos' },
            { value: 'ensino-medio-mais', label: 'Programa Ensino Médio Mais' },
            { value: 'brasil-nas-escolas', label: 'Programa Brasil na Escola' },
            { value: 'primeira-infancia', label: 'Programa Primeira Infância na Escola' },
            { value: 'escola-adolescencia', label: 'Programa Escola das Adolescências' },
...
const escolas = [
    ...
    { value: "caic-julia-kubitschek-de-oliveira", nome: "CAIC JULIA KUBITSCHEK DE OLIVEIRA" },
...
const contaCCorrenteData = [
    ...
    },
    {
        ...
        type: "radio",
        class: "checklist-item",
        hasDetails: true, // Indica que há campos adicionais para pendência
        detailsType: "group-date", // Tipo do detalhe (grupo de campos)
        classDetails: "hidden group-date",
        detailsFields: [ // Campos a serem exibidos
            {
                type: "date",
                label: "Data",
                name: "extrato-corrente-data-nao-aplicacao",
                required: true
            },
            {
                type: "text",
                label: "R$",
                name: "extrato-corrente-valor-financeiro-nao-aplicacao",
                placeholder: "R$ 0,00",
                required: true
            }
        ],
        ...
        detailsFields: [ // Campos a serem exibidos
            {
                type: "date",
                label: "Data",
                name: "extrato-corrente-data-despesa-sem-comprovacao",
                required: true
            },
            {
                type: "text",
                label: "R$",
                name: "extrato-corrente-valor-financeiro-despesa-sem-comprovacao",
                placeholder: "R$ 0,00",
                required: true
            }
        ],
        ...
        detailsFields: [ // Campos a serem exibidos
            {
                type: "date",
                label: "Data",
                name: "extrato-corrente-data-despesa-nao-autorizada",
                required: true
            },
            {
                type: "text",
                label: "R$",
                name: "extrato-corrente-valor-financeiro-despesa-nao-autorizada",
                placeholder: "R$ 0,00",
                required: true
            }
        ],
...
const notaFiscalData = [
    ...
    },
    {
        ...
        //tem que criar um span antes de cada label <span></span>
        detailsOptions: [
            { value: "ausente-ou-nao-preenchido", label: "Carimbo ausente/não preenchido" },
            { value: "data-incorreta", label: "Data incorreta/ausente" },
            { value: "problema-matricula-assinatura", label: "Problema na matricula/assinatura" }
        ],
...
const contratoServicoData = [
    ...
    },
    {
        ...
        detailsOptions: [
            ...
            { value: "anterior-orcamento", label: "Contrato anterior a algum orçamento" }
        ],
...
const qdBlocoDoisData = [
    ...
    },
    {
        ...
        //div com a classe abaixo
        classDetails: "checkbox-group hidden checkbox-line",
        detailsName: "quadro-demonstrativo-bloco-dois-saldo-a-reprogramar-incorreto",
        //tem que criar um span antes de cada label <span></span>
        detailsOptions: [
            { value: "total", label: "Valor total diferente do último dia útil de dezembro" },
            { value: "categoria-economica", label: "Custeio/capital inadequados" },
            { value: "remanejamento-entre-categorias", label: "Remanejamento entre categorias (custeio/capital)" },
            { value: "remanejamento-entre-acoes", label: "Remanejamento entre ações" }
        ],
