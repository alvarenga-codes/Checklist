...
const ataPrioridadesData = [
  ...
  {
    item: "Custeio: despesas previstas na ata",
  ...
  {
    item: "Capital: despesas previstas na ata",
  ...
  },
  {
    ...
    detailsPlaceholder:
      "Especifique o(s) nome(s) do(s) membro(s) não eleito(s)",
  },
  {
...
const contaCInvestimentoData = [
  //Cabeçalho
  {
    header: true,
    //Adicionar div com essa identificação
    divClass: "form-group box-type in-text box-remove",
    //Adicionar label (aninhado a div) com nome abaixo
...
const devolucaoEscolaData = [
  ...
  //Linhas
  {
    ...
    detailsRow: "1",
    detailsCols: "18",
    detailsLabel: "Devolução",
    detailsName: "devolucao-conta-escola-arquivo-dados",
    dataTarget: "devolucao-conta-escola-arquivo",
    detailsPlaceholder: "Valor e data",
  },
  {
    ...
    detailsCols: "18",
    detailsLabel: "Devolução",
    detailsName: "devolucao-conta-escola-comprovante-dados",
    dataTarget: "devolucao-conta-escola-comprovante",
    detailsPlaceholder: "Valor e data",
  },
  {
    ...
    detailsCols: "18",
    detailsLabel: "Devolução",
    detailsName: "devolucao-conta-escola-correcao-dados",
    dataTarget: "devolucao-conta-escola-correcao",
    detailsPlaceholder: "Valor e data",
  },
  {
    item: "Justificativa",
    ...
    detailsCols: "18",
    detailsLabel: "Devolução",
    detailsName: "devolucao-conta-escola-justificativa-dados",
    dataTarget: "devolucao-conta-escola-justificativa",
    detailsPlaceholder: "Valor e data",
  },
];
...
const devolucaoFNDEData = [
  ...
  {
    item: "Extrato atual que demonstra conta zerada (se for o caso)",
    name: "devolucao-fnde-extrato",
    valueAprovado: "correto",
    valuePendencia: "incorreto",
    type: "radio",
    hasDetails: false,
...
const notaFiscalData = [
  ...
  },
  {
    ...
    detailsOptions: [
      ...
      {
        value: "informacoes-incompleto",
        label: "Carimbo incompleto (digitalização)",
      },
  ...
  },
  {
    ...
    detailsOptions: [
      ...
      { value: "data-incorreta", label: "Data incorreta/ausente" },
      {
        ...
        label: "Problema na matrícula/assinatura",
      },
      {
        value: "informacoes-incompleto",
        label: "Carimbo incompleto (digitalização)",
...
const aprovacaoPCAData = [
  ...
  {
    item: "Lista de presentes: ausência de assinatura de membros",
...
const qdBlocoTresData = [
  {
    ...
    detailsPlaceholder: "Item X, campo Y",
  },
];
...
window.observacoesGerais = [
  {
    naoAprovado:
      "<b>Despesas não aprovadas</b><br>A Unidade Executora (UEx) deverá calcular os valores não aprovados e restituir os montantes correspondentes à conta indicada para devolução de recursos, conforme determina a Resolução vigente.<br>O valor a ser restituído deve ser atualizado até a data do depósito, utilizando o Sistema de Atualização de Débito do Tribunal de Contas da União (TCU), em conformidade com o art. 41, § 3º, da Resolução FNDE nº 15/2021.",
  },
  {
    despesaSemComprovacao:
      "<b>Despesas sem documentação comprobatória:</b><br>A Unidade Escolar deverá anexar, neste processo, os documentos que comprovem a execução da despesa, tais como nota fiscal, comprovante de pagamento e demais documentos pertinentes.<br>Caso não seja possível apresentar a documentação comprobatória, a despesa não será considerada aprovada, devendo a Unidade realizar a devolução integral dos valores correspondentes, devidamente atualizados, mediante cálculo realizado no Sistema de Atualização de Débito do Tribunal de Contas da União (TCU), com depósito na conta vinculada ao programa.",
  },
  {
    naoAplicadoPrazo:
